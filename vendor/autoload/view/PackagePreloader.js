var PackagePreloader = function() {
	...
	this.init = function(config) {
		...
		if (config.currentProgress) {
			this.interpretCurrent = config.currentProgress;
		} else {
			console.error("PackagePreloader.init: Config object requires 'currentProgress' function. This function must return a number between 0 and 1 to express the progress of loading.");
		}
	};
	...
	this.update = function() {
		// Need to implement an inline interpret current, defined from the package loader. It will always return a number between 0 and 1.
